...
public class DriverScript {
	...
	private void initializeWebDriver() {
		...
		case HEALENIUM:
			...
			WebDriverFactory.getSelfHealingDriver(testParameters.getBrowser());
			driver = new CraftDriver(SHdriver); 
			break;
	...
	private void initializeTestScript() {
		...
		scriptHelper = new ScriptHelper(dataTable, report, driver.getSelfHealingDriver(), driverUtil, apiDriver, extentTest, reusableHandle);
		if (!isAPITest()) {
