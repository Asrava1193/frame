...
public class CraftDriver {
	...
	public Object commonDriver;
	public CraftDriver(WebDriver driver) {
		this.driver = driver;
	}

	public CraftDriver (SelfHealingDriver driver) {//public CraftDriver(Object driver) {​
	...
	public SelfHealingDriver getSelfHealingDriver() {
	return  SHdriver;
}
	...
	public WebElement findElement(By arg0) {
	    if(testParameters.getExecutionMode()==ExecutionMode.HEALENIUM) {
	    return SHdriver.findElement(arg0);	
	    }
	    else {
	 ...
	 *            {@link WebDriver}
	 */
	public List<WebElement> findElements(By arg0) {//public List<WebElement> findElements(By arg0) {​​

		if(testParameters.getExecutionMode()==ExecutionMode.HEALENIUM) {
			return SHdriver.findElements(arg0);
	...
	public String getWindowHandle() {
		if(testParameters.getExecutionMode()==ExecutionMode.HEALENIUM) {
			return SHdriver.getWindowHandle();
	...
	public Set<String> getWindowHandles() {
		...
		if(testParameters.getExecutionMode()==ExecutionMode.HEALENIUM) {
			return SHdriver.getWindowHandles();
