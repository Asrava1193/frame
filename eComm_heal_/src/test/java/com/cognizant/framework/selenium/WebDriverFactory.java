...
public class WebDriverFactory {
	...
	public static WebDriver getWebDriver(Browser browser) {
		...
		case HEALENIUM:
			...
			SelfHealingDriver SHdriver = SelfHealingDriver.create(delegate);
	...
	public static SelfHealingDriver getSelfHealingDriver(Browser browser) {//public static SelfHealingDriver getSelfHealingDriver(Browser browser) {​
		SelfHealingDriver SHdriver= null;
		properties= Settings.getInstance();
		switch (browser) {
		case HEALENIUM:
		System.setProperty("webdriver.chrome.driver", properties.getProperty("ChromeDriverPath"));
		WebDriver delegate = new ChromeDriver();
		SHdriver = SelfHealingDriver.create(delegate);
		
		/*SHdriver.get("file://C:/saravanan/yetiforce.html");
		SHdriver.findElement(By.id("username")).sendKeys("hi");*/
